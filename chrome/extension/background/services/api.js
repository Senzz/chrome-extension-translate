...
const getToken = require('./tk');
const axios = require('axios');

module.exports = {
  translate, complete, translateComplete, voice
}
...
async function complete(text, lang) {
    try {
...
async function translateComplete(words, opts) {
    try {
...
async function voice(text, lang, speed) {
